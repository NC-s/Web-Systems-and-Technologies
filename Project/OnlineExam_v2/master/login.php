...
if (isset ($_COOKIE["admin_login_id"])){
	setcookie("admin_login_id",$_COOKIE['admin_login_id'],time()-(3600));
}
  ...
  <div class="container">
      <div class="row">
        ...
        <div class="col-md-6" style="margin-top:100px;">
          ...
          <div class="card">
            <div class="card-header">Teacher / Admin Login</div>
            <div class="card-body">
              <form method="post" id="admin_login_form">
                <div class="form-group">
                  <label>Login ID</label>
                  <input type="text" name="admin_login_id" id="admin_login_id" placeholder="Enter Login ID" class="form-control" />
                </div>
                <div class="form-group">
			  ...
			  <div>
				<small class="form-text text-secondary text-center"><a href="/onlineExam_v2/index.php">Back To User</a>
              </div>
            </div>
          </div>
      ...
      $.ajax({
        ...
        success:function(data)
        {
          if(data.success)
          {
			...
			<?php
			setcookie("admin_login_id",$_POST['admin_login_id'],time()+(60*60*24));
			?>
          }
          else
          {
