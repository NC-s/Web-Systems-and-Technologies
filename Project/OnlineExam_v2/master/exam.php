        		...
        		<div class="modal-body">
					...
					<div class="form-group">
            			<div class="row">
							...
							<div class="col-md-8">	
								<select name="questionType" id="questionType" class="form-control" onchange='checkType(this.value)'>
	                				<option value="">--Select--</option>
          			...
          			<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right" id="option3text">Option 3 <span class="text-danger">*</span></label>
	              			<div class="col-md-8">
          			...
          			<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right" id="option4text">Option 4 <span class="text-danger">*</span></label>
	              			<div class="col-md-8">
...
$(document).ready(function(){
	...
	function checkType(Type){
		if (Type != 'Multiple Choice' && Type != 'True/False' && Type != 'Short Answer' && Type != 'Short Answer'){
			document.getElementById('option_title_1').disabled = true;
			document.getElementById('option_title_2').disabled = true;
			document.getElementById('option_title_3').disabled = true;
			document.getElementById('option_title_4').disabled = true;
			document.getElementById("question_type").value = "";
			
		}else{
			
			if (Type == 'Multiple Choice'){
				document.getElementById('option_title_1').disabled = false;
				document.getElementById('option_title_2').disabled = false;
				document.getElementById('option_title_3').disabled = false;
				document.getElementById('option_title_4').disabled = false;
				document.getElementById("option_title_1").value = "";
				document.getElementById("option_title_2").value = "";
				document.getElementById("option_title_3").value = "";
				document.getElementById("option_title_4").value = "";
				document.getElementById("question_type").value = "Multiple Choice";
			}
		}
			if (Type == 'True/False'){
				document.getElementById('option_title_1').disabled = false;
				...
				document.getElementById('option_title_3').disabled = false;
				document.getElementById('option_title_4').disabled = false;
				document.getElementById("option_title_1").value = "True";
				document.getElementById("option_title_2").value = "False";
				document.getElementById("option_title_3").value = "Null";
				document.getElementById("option_title_4").value = "Null";
				document.getElementById("question_type").value = "True/False";
			...
			if (Type == 'Short Answer'){
				...
				document.getElementById('option_title_4').disabled = false;
				document.getElementById("option_title_1").value = "";
				document.getElementById("option_title_2").value = "Null";
				document.getElementById("option_title_3").value = "Null";
				document.getElementById("option_title_4").value = "Null";
				document.getElementById("question_type").value = "Short Answer";
			...
			if (Type == 'Fill in the blank'){
				...
				document.getElementById("option_title_3").value = "Null";
				document.getElementById("option_title_4").value = "Null";
				document.getElementById("question_type").value = "Fill in the blank";
